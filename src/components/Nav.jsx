function Header() {
  return (
    <div className="bg-gray-800 text-white shadow-xl h-[50px] flex items-center shadow-sm mx-auto fixed top-0 left-0 w-full z-50">
      <h2 className="mx-8 font-black">
        About{" "}
      ...
      <div className="grow">
        <div className="flex justify-center gap-2 md:gap-8 font-bold">
