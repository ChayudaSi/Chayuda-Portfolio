  ...
  return (
    <div className="bg-gray-800 shadow-xl mx-auto ">
        <div className = "text-center text-white">
            ...
            <p className="text-gray-300 border-b">Thank you for visiting my personal portfolio website.I hope you enjoyed exploring my work.Don’t hesitate to reach out.</p>
        </div>        
