...
const education = [
  {
    ...
    description: "Graduated with a GPA 3.38. Specialized in Embedded Systems, Programming.",
...
const Timeline = ({events}) => {
  return (
    <div className = "flex flex-col flex-wrap gap-y-3 w-full my-4"  id="education">
      <div className = "mt-20 text-white font-extrabold text-4xl flex justify-center">
        ...
        <h3 className="mx-2 text-4xl">Education</h3>
      </div>
...
const EventCard = ({year, title,location,description}) => {
  return (
    <div className = "rounded-lg bg-gray-800 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl flex flex-col gap-y-2 shadow-md rounded-xml-xl p-4">
        ...
        <h3 className = "text-xl text-transparent bg-clip-text bg-gradient-to-r text-bold from-green-400 to-blue-500 font-bold text-lg border-b">{title}</h3>
        <div className = "text-white flex">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 1 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <h2 className = "text-l text-white-800 text-white mx-2">{location}</h2>
        </div>
