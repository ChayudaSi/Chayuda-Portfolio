...
const activity = [
  {
    ...
    description: [
      "Project: Wireless Sensor Network for Temperature Monitoring",
  ...
  },
  {
    ...
    description: [
      "Environment: FreeRTOS ,ESP32, Programming C / C++, Edge Impulse",
  ...
  },
  {
    ...
    description: ["Public Relations", "Vice President"],
  },
  {
    id: 5,
    title: "Startup Thailand League 2022",
    description: [
      "Participated in the Startup Thailand League 2022 as part of the Kids Finder team, developing a location tracking device. Designed and built a prototype to showcase during the Demo Day event.",
    ],
  },
  {
    id: 6,
    title: "Volunteer Instructor: E-Camp",
    description: ["Basic Electronic measurement", "Basic Programming Arduino"],
  },
  {
    id: 7,
    title: "Volunteer Instructor: Embedded Workshop",
    description: ["Basic Arduino programming", "IOT Programming using ESP32"],
  },
  {
    id: 8,
    title: "Volunteer Instructor:  PCB Prototype Workshop",
    description: ["Basic electronic measurement", " PCB design using EasyEDA"],
  },
];
      ...
      <div className="container mx-auto lg:px-24 mt-20">
        ...
        <div className="grid grad-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
          {activity.map((activity) => (
            <div
              key={activity.id}
              className="bg-gray-800 pb-6 px-6 rounded-lg mt-3"
            >
              <div className="mt-2 text-right text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                {activity.id}
              </div>
              <h2 className="mt-2 text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                {activity.title}
              </h2>
