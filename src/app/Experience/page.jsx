...
const experience = [
  {
    ...
    description: [
      "Developed Core Banking software by using Avaloq (PL/SQL) programming.",
      "Using SQL for data analysis , support appropriate system design and development",
      "Designed test cases and Perform unit testing after completing system development. (Functional, UI , API)",
      "Create a UML Diagram to explain the operation of a Technical Documentation Development (TDD) system",
    ],
  ...
  },
  {
    ...
    description: [
      "Developed control functions on the Infineon TC275 lite kit using FreeRTOS and C Programming.",
      "Established seamless communication across CAN, I2C and UART protocols",
      "Designed a GUI for easy system control and interfacing",
      "Conducted thorough testing to ensure the system performance",
    ],
    ...
    <div className="flex flex-col gap-y-3 w-full my-4 items-center justify-center">
      <div className="flex text-white items-center">
        <svg
          ...
          viewBox="0 0 16 16"
          fill="currentColor"
          className="w-10 h-10 mt-20 mr-2"
        >
          <path
            fill-rule="evenodd"
    ...
    <div className="rounded-lg bg-gray-800 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl flex flex-col gap-y-2 shadow-md rounded-xml-xl p-4 flex-wrap">
      ...
      <ul className="mx-3 mt-2 list-disc list-inside">
        {description.map((item, index) => (
          <li className="text-gray-400 text-l" key={index}>
            {item}
          </li>
        ))}
      </ul>
